...
func (UnimplementedActivityServiceServer) RegisterUserActivity(context.Context, *RegisterUserActivityRequest) (*ActivityResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RegisterUserActivity not implemented")
}
...
func (UnimplementedActivityServiceServer) GetUserCreatedActivities(context.Context, *GetUserActivitiesRequest) (*ActivitiesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUserCreatedActivities not implemented")
}
func (UnimplementedActivityServiceServer) GetUserRegisteredActivities(context.Context, *GetUserActivitiesRequest) (*ActivitiesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUserRegisteredActivities not implemented")
}
